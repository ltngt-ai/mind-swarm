...
# Switch between cognitive loop versions
USE_V2_COGNITIVE_LOOP = True

if USE_V2_COGNITIVE_LOOP:
...
class AgentMind:
    ...
    async def _autonomous_action(self):
        ...
        logger.info("Agent is idle - could explore the Grid or review memory")
