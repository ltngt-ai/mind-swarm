...
class AgentRuntimeBuilder:
    ...
    def _verify_base_code_templates(self):
        ...
        The base_code templates are maintained in grid/library/non-fiction/mind_swarm_tech/base_code
        and copied to each Cyber's home directory when they are created.
        """
        base_code_dir = self.library_dir / "non-fiction" / "mind_swarm_tech" / "base_code"
        ...
        if not base_template.exists():
            ...
            logger.error("Please ensure grid/library/non-fiction/mind_swarm_tech/base_code/base_code_template exists")
            return
